...
MMKV-style fast key/value storage backed by the librayact_mmkv native plugin

```sh
# Installed transitively by rayact; direct tarball for maintainer debugging:
npm install https://github.com/raythings/rayact/releases/download/v0.0.1/rayact-mmkv-0.0.1.tgz
```
