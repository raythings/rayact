...
crypto.getRandomValues + crypto.randomUUID polyfill for QuickJS-hosted React

```sh
# Installed transitively by rayact; direct tarball for maintainer debugging:
npm install https://github.com/raythings/rayact/releases/download/v0.0.1/rayact-crypto-0.0.1.tgz
```
