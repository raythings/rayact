import type { RayactAsset, RayactGlobal } from './types';
import { isRayactAsset } from './assets';
 ...
 */
export async function loadFont(name: string, source: FontSource): Promise<void> {
  const g = getGlobal();
