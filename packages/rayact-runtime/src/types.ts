...
export interface RayactGlobal {
  ...
  loadFont?: (name: string, source: string | Uint8Array, options?: { codepoints?: number[] }) => void;
  ...
  __RAYACT_CLIENT_CAPABILITIES__?: import('./capabilities.js').ClientCapabilityManifest | string;
  ...
  __rayactRecordCrash?: (error: unknown, kind?: 'fatal-js' | 'unhandled-rejection' | 'native-exception' | 'native-signal') => void;
}
