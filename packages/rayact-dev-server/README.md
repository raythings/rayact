...
Vite-powered Rayact development server and debugger transport

```sh
# Installed transitively by rayact; direct tarball for maintainer debugging:
npm install https://github.com/raythings/rayact/releases/download/v0.0.1/rayact-dev-server-0.0.1.tgz
```
