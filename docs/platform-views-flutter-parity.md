...
**rayact today is mode 1**, the one Flutter is trying to delete
([`raym3_bridge.cpp:2758`](../native/desktop/raym3_bridge.cpp), Android `VirtualDisplay` +
...
| props to the native view | **broken** — `kForwarded[] = {"value","placeholder","inputType","secure"}` at [`raym3_bridge.cpp:2869`](../native/desktop/raym3_bridge.cpp) drops every webview prop | absent |
