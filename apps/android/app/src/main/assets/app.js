(function() {
  ...
  globalThis.importCSS("./css/ab52694d-avoid-keyboard.css");
...
${stack}` : message;
  ...
  var define_RAYACT_OFFICIAL_APP_default = { displayName: "Rayact Dev App", packageLabel: "Rayact Dev App", source: "official", androidPackageId: "com.rayact.devapp", creditTitle: "The official Rayact development client", links: [{ id: "github", icon: "github", set: "fab", label: "GitHub", url: "https://github.com/rayact/rayact" }, { id: "email", icon: "envelope", set: "fa", label: "ramnadroj@gmail.com", url: "mailto:ramnadroj@gmail.com" }] };
  ...
  function DevLauncherProvider({ children }) {
    ...
    const recentListKey = reactExports.useMemo(
    ...
    const probeAllRecents = reactExports.useCallback((entries, initial) => {
      ...
      if (initial) {
        setRecentReachability(
          Object.fromEntries(entries.map((e) => [e.url, "checking"]))
        );
      }
      let cancelled = false;
      void (async () => {
  ...
  function ServerListRow(props) {
    ...
    const row = /* @__PURE__ */ jsxRuntimeExports.jsxs(View, { style: { flexDirection: "row", alignItems: "center", gap: 12, width: "100%", minWidth: 0 }, children: [
      ...
      /* @__PURE__ */ jsxRuntimeExports.jsxs(View, { style: { flexGrow: 1, flexShrink: 1, minWidth: 0, gap: 2 }, children: [
        /* @__PURE__ */ jsxRuntimeExports.jsx(Text, { style: { text: { color: colors.onSurface, fontSize: 15, fontWeight: 500 } }, children: title }),
        subtitle ? /* @__PURE__ */ jsxRuntimeExports.jsx(Text, { style: { text: { color: colors.onSurfaceVariant, fontSize: 13 } }, children: subtitle }) : null
      ] })
    ] });
    ...
    return /* @__PURE__ */ jsxRuntimeExports.jsx(
      View,
      {
        ...
        capturesInput: true,
        onPress: disableTap ? void 0 : onPress,
        children: row
      }
    );
  }
  ...
  function RecentSwipeRow(props) {
    ...
    return /* @__PURE__ */ jsxRuntimeExports.jsxs(View, { style: { position: "relative", overflow: "hidden", borderRadius: 12, width: "100%" }, children: [
      /* @__PURE__ */ jsxRuntimeExports.jsx(
        View,
        {
          style: {
      ...
      open ? /* @__PURE__ */ jsxRuntimeExports.jsx(
        View,
        {
          ...
          children: /* @__PURE__ */ jsxRuntimeExports.jsx(Text, { style: { text: { color: 4294967295, fontSize: 13, fontWeight: 600 } }, children: "Delete" })
        }
      ) : null
    ] });
  }
  ...
  function CombinedServerList(props) {
    ...
    if (merged.length === 0) {
      return /* @__PURE__ */ jsxRuntimeExports.jsx(View, { style: { gap: 8, paddingTop: 4, paddingBottom: 24 }, children: /* @__PURE__ */ jsxRuntimeExports.jsx(Text, { style: { text: { color: colors.onSurface, fontSize: 14 } }, children: "Scanning for servers on your network… Saved servers also appear here." }) });
    }
    const visibleMerged = merged.length > MAX_RENDERED_ROWS ? merged.slice(0, MAX_RENDERED_ROWS) : merged;
    return /* @__PURE__ */ jsxRuntimeExports.jsxs(View, { style: { gap: 10, paddingTop: 4, paddingBottom: 24 }, children: [
      visibleMerged.map(
        (m) => m.saved ? /* @__PURE__ */ jsxRuntimeExports.jsx(
          RecentSwipeRow,
          {
            title: m.title,
            subtitle: m.subtitle,
      ...
      merged.length > MAX_RENDERED_ROWS ? /* @__PURE__ */ jsxRuntimeExports.jsxs(Text, { style: { text: { color: colors.onSurfaceVariant, fontSize: 12 } }, children: [
        "Showing first ",
        MAX_RENDERED_ROWS,
  ...
  function IncompatibleModal() {
    ...
    return /* @__PURE__ */ jsxRuntimeExports.jsx(
      View,
      {
        style: { ...modalOverlayStyle, backgroundColor: 2566914048 },
        ...
        children: /* @__PURE__ */ jsxRuntimeExports.jsxs(
          View,
          {
            ...
            children: [
              /* @__PURE__ */ jsxRuntimeExports.jsx(Text, { style: { text: { color: colors.onSurface, fontSize: 18, fontWeight: 600 } }, children: "Incompatible server" }),
              /* @__PURE__ */ jsxRuntimeExports.jsx(Text, { style: { text: { color: colors.onSurface, fontSize: 14 } }, children: "This app is missing native modules required by the project:" }),
              /* @__PURE__ */ jsxRuntimeExports.jsx(View, { style: { gap: 6 }, children: launcher.incompatibleModules.map((m) => /* @__PURE__ */ jsxRuntimeExports.jsx(
                Text,
                {
                  style: { text: { color: colors.onSurface, fontSize: 14 } },
                  children: m.jsPackage ? `${m.name} (${m.jsPackage})` : m.name
                },
                m.name
              )) }),
              /* @__PURE__ */ jsxRuntimeExports.jsx(
                View,
                {
                  ...
                  onPress: () => launcher.setIncompatibleModalVisible(false),
                  children: /* @__PURE__ */ jsxRuntimeExports.jsx(Text, { style: { text: { color: colors.onPrimary, fontSize: 15, fontWeight: 600 } }, children: "OK" })
                }
              )
            ]
          }
  ...
  function ConnectPage() {
    ...
    return /* @__PURE__ */ jsxRuntimeExports.jsxs(View, { style: { ...pageStyle, backgroundColor: colors.surface, flexGrow: 1, gap: 0 }, children: [
      /* @__PURE__ */ jsxRuntimeExports.jsxs(View, { style: sectionStyle, children: [
        /* @__PURE__ */ jsxRuntimeExports.jsx(Text, { style: { text: { color: colors.onSurface, fontSize: 14, fontWeight: 600 } }, children: "Connect to dev server" }),
        /* @__PURE__ */ jsxRuntimeExports.jsx(Text, { style: { text: { color: colors.onSurface, fontSize: 14 } }, children: "Start a local development server with: npx rayact dev" }),
        /* @__PURE__ */ jsxRuntimeExports.jsx(Text, { style: { text: { color: colors.onSurface, fontSize: 14 } }, children: "Then, enter the dev server URL when it appears here." }),
        /* @__PURE__ */ jsxRuntimeExports.jsx(
          TextInput,
          {
            value: input,
        ...
        launcher.connectError ? /* @__PURE__ */ jsxRuntimeExports.jsx(Text, { style: { text: { color: colors.error, fontSize: 14, marginBottom: 12 } }, children: launcher.connectError }) : null,
        launcher.connecting ? /* @__PURE__ */ jsxRuntimeExports.jsx(Text, { style: { text: { color: colors.onSurfaceVariant, fontSize: 12 } }, children: "Connecting…" }) : null,
        /* @__PURE__ */ jsxRuntimeExports.jsxs(View, { style: { gap: 12, marginTop: 4 }, children: [
          /* @__PURE__ */ jsxRuntimeExports.jsx(
            Button,
            {
              label: "Connect",
          ...
          /* @__PURE__ */ jsxRuntimeExports.jsx(Text, { style: { text: { color: colors.onSurface, fontSize: 14, textAlign: "center" } }, children: "Or" }),
          /* @__PURE__ */ jsxRuntimeExports.jsx(
            View,
            {
              onPress: launcher.onScanQR,
              style: { ...secondaryButtonStyle, backgroundColor: colors.surfaceContainer },
              children: /* @__PURE__ */ jsxRuntimeExports.jsx(Text, { style: { text: { color: 4294967295, fontSize: 15, fontWeight: 600 } }, children: "Scan QR code" })
            }
          )
        ] })
      ] }),
      /* @__PURE__ */ jsxRuntimeExports.jsxs(View, { style: { ...sectionStyle, paddingLeft: 6, paddingRight: 6 }, children: [
        /* @__PURE__ */ jsxRuntimeExports.jsx(Text, { style: { text: { color: colors.onSurface, fontSize: 14, fontWeight: 600, marginBottom: 4 } }, children: "Servers" }),
        /* @__PURE__ */ jsxRuntimeExports.jsx(Text, { style: { text: { color: colors.onSurface, fontSize: 14, marginBottom: 8 } }, children: "Swipe left on a saved row to delete." })
      ] }),
      /* @__PURE__ */ jsxRuntimeExports.jsx(ScrollView, { style: { flexGrow: 1, flexShrink: 1, minHeight: 0, width: "100%" }, children: /* @__PURE__ */ jsxRuntimeExports.jsx(View, { style: { paddingLeft: 6, paddingRight: 6, paddingBottom: 16, width: "100%" }, children: /* @__PURE__ */ jsxRuntimeExports.jsx(
        CombinedServerList,
        {
  ...
  function AboutPage() {
    ...
    return /* @__PURE__ */ jsxRuntimeExports.jsxs(ScrollView, { style: { ...pageStyle, backgroundColor: colors.surface, flexGrow: 1 }, children: [
      /* @__PURE__ */ jsxRuntimeExports.jsx(Text, { style: { text: { color: colors.onSurface, fontSize: 18, fontWeight: 600, marginBottom: 16 } }, children: "About" }),
      official.displayName ? /* @__PURE__ */ jsxRuntimeExports.jsxs(View, { style: { ...sectionStyle, backgroundColor: colors.surfaceContainer, borderRadius: 12, padding: 16, borderWidth: 1, borderColor: cardBorder, marginBottom: 16 }, children: [
        /* @__PURE__ */ jsxRuntimeExports.jsx(Text, { style: { text: { color: colors.onSurface, fontSize: 17, fontWeight: 600 } }, children: official.displayName }),
        official.creditTitle ? /* @__PURE__ */ jsxRuntimeExports.jsx(Text, { style: { text: { color: colors.onSurfaceVariant, fontSize: 13, marginTop: 4 } }, children: official.creditTitle }) : null,
        (official.links ?? []).map((link) => /* @__PURE__ */ jsxRuntimeExports.jsxs(Text, { style: { text: { color: colors.onSurfaceVariant, fontSize: 13, marginTop: 8 } }, children: [
          link.label,
          ": ",
          link.url
        ] }, link.id))
      ] }) : null,
      /* @__PURE__ */ jsxRuntimeExports.jsxs(View, { style: { ...sectionStyle, backgroundColor: colors.surfaceContainer, borderRadius: 12, padding: 16, borderWidth: 1, borderColor: cardBorder, marginBottom: 16 }, children: [
        /* @__PURE__ */ jsxRuntimeExports.jsx(Text, { style: { text: { color: colors.onSurfaceVariant, fontSize: 12, fontWeight: 600, letterSpacing: 0.4 } }, children: "PACKAGE" }),
        /* @__PURE__ */ jsxRuntimeExports.jsxs(View, { style: { gap: 6, marginTop: 12 }, children: [
          /* @__PURE__ */ jsxRuntimeExports.jsx(Text, { style: { text: { color: colors.onSurface, fontSize: 14 } }, children: "Dev client (npm)" }),
          /* @__PURE__ */ jsxRuntimeExports.jsxs(Text, { style: { text: { color: colors.onSurface, fontSize: 15, fontWeight: 500 } }, children: [
            "Version ",
            nativeVersion !== "—" ? nativeVersion : DEV_CLIENT_VERSION
          ] })
        ] })
      ] }),
      /* @__PURE__ */ jsxRuntimeExports.jsxs(View, { style: { ...sectionStyle, backgroundColor: colors.surfaceContainer, borderRadius: 12, padding: 16, borderWidth: 1, borderColor: cardBorder, marginBottom: 16 }, children: [
        /* @__PURE__ */ jsxRuntimeExports.jsx(Text, { style: { text: { color: colors.onSurfaceVariant, fontSize: 12, fontWeight: 600, letterSpacing: 0.4 } }, children: "NATIVE APP" }),
        /* @__PURE__ */ jsxRuntimeExports.jsxs(View, { style: { gap: 6, marginTop: 12 }, children: [
          /* @__PURE__ */ jsxRuntimeExports.jsx(Text, { style: { text: { color: colors.onSurface, fontSize: 14 } }, children: "Identifier" }),
          /* @__PURE__ */ jsxRuntimeExports.jsx(Text, { style: { text: { color: colors.onSurface, fontSize: 15, fontWeight: 500 } }, children: bundleId })
        ] }),
        /* @__PURE__ */ jsxRuntimeExports.jsxs(View, { style: { gap: 6, marginTop: 14 }, children: [
          /* @__PURE__ */ jsxRuntimeExports.jsx(Text, { style: { text: { color: colors.onSurface, fontSize: 14 } }, children: "Version" }),
          /* @__PURE__ */ jsxRuntimeExports.jsx(Text, { style: { text: { color: colors.onSurfaceVariant, fontSize: 15, fontWeight: 500 } }, children: nativeVersion })
        ] })
      ] }),
      /* @__PURE__ */ jsxRuntimeExports.jsxs(View, { style: { ...sectionStyle, backgroundColor: colors.surfaceContainer, borderRadius: 12, padding: 16, borderWidth: 1, borderColor: cardBorder }, children: [
        /* @__PURE__ */ jsxRuntimeExports.jsx(Text, { style: { text: { color: colors.onSurfaceVariant, fontSize: 12, fontWeight: 600, letterSpacing: 0.4 } }, children: "RAYACT" }),
        /* @__PURE__ */ jsxRuntimeExports.jsxs(View, { style: { gap: 6, marginTop: 12 }, children: [
          /* @__PURE__ */ jsxRuntimeExports.jsx(Text, { style: { text: { color: colors.onSurface, fontSize: 14 } }, children: "Runtime" }),
          /* @__PURE__ */ jsxRuntimeExports.jsx(Text, { style: { text: { color: colors.onSurfaceVariant, fontSize: 15, fontWeight: 500 } }, children: rayactVersion })
        ] })
      ] }),
      bundledModules.length > 0 ? /* @__PURE__ */ jsxRuntimeExports.jsxs(View, { style: { ...sectionStyle, backgroundColor: colors.surfaceContainer, borderRadius: 12, padding: 16, borderWidth: 1, borderColor: cardBorder, marginTop: 16 }, children: [
        /* @__PURE__ */ jsxRuntimeExports.jsx(Text, { style: { text: { color: colors.onSurfaceVariant, fontSize: 12, fontWeight: 600, letterSpacing: 0.4 } }, children: "BUNDLED NATIVE MODULES" }),
        /* @__PURE__ */ jsxRuntimeExports.jsx(View, { style: { gap: 6, marginTop: 12 }, children: bundledModules.map((m) => /* @__PURE__ */ jsxRuntimeExports.jsx(Text, { style: { text: { color: colors.onSurface, fontSize: 14 } }, children: m.jsPackage ? `${m.name} · ${m.jsPackage}` : m.name }, m.name)) })
      ] }) : null
    ] });
  }
  function DevLauncherNavBar({ tab, onTabChange }) {
    const launcher = useDevLauncher();
    const colors = themeColors(launcher.theme);
    return /* @__PURE__ */ jsxRuntimeExports.jsx(NavigationBar, { ignoreSafeAreaView: true, style: { flexShrink: 0 }, children: TABS.map((item) => {
  ...
  function DevLauncherUI() {
    ...
    return /* @__PURE__ */ jsxRuntimeExports.jsxs(View, { style: { flexGrow: 1, backgroundColor: colors.surface }, children: [
      /* @__PURE__ */ jsxRuntimeExports.jsx(
        View,
        {
          style: {
          ...
          children: tab === "connect" ? /* @__PURE__ */ jsxRuntimeExports.jsx(ConnectPage, {}) : /* @__PURE__ */ jsxRuntimeExports.jsx(AboutPage, {})
        }
      ),
      /* @__PURE__ */ jsxRuntimeExports.jsx(IncompatibleModal, {}),
      /* @__PURE__ */ jsxRuntimeExports.jsx(DevLauncherNavBar, { tab, onTabChange: setTab })
    ] });
  }
  function DevMenu() {
    const launcher = useDevLauncher();
