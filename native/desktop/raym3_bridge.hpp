...
JSValue JS_rayactClipboardRead(JSContext*, JSValue, int, JSValueConst*);
JSValue JS_rayactClipboardWrite(JSContext*, JSValue, int, JSValueConst*);
JSValue JS_rayactClipboardHasString(JSContext*, JSValue, int, JSValueConst*);
...
JSValue JS_createModuleNode(JSContext*, JSValue, int, JSValueConst*);
JSValue JS_setModuleNodeProps(JSContext*, JSValue, int, JSValueConst*);
