...
// compileJSToBytecode moved to native/shared/qjs_compile.cpp so the headless
// rayact_tool binary shares the exact writer with the desktop host's
// (deprecated) --compile path.
